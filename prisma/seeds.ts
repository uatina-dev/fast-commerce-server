...
const snacks = [
  {
    ...
    name: "Zero-Mac",
    description:
      "O artesanal tamanho família recheado com três carnes suculentas, queijo zero lactose e bacon.",
    price: 25.5,
  ...
  },
  {
    ...
    name: "Extra Bacon",
    description:
      "Criado para os amantes de bacon, possui em todas as suas camadas bacon bem assado e ainda queijo zero lactose e carne.",
    price: 23.5,
  ...
  },
  {
    ...
    name: "Carne dupla",
    description:
      "Já pensou em comer aquele sanduíche com carne dupla e saborosa, recheada com queijo zero lactose, molho e salada? Então você pensou exatamente nesse hambúrguer.",
    price: 20,
  ...
  },
  {
    ...
    name: "Batata zero",
    description:
      "Pizza de batata recheada com queijo zero lactose, cebola.",
    price: 25,
  ...
  },
  {
    ...
    description:
      "Pizza recheada com lombo canadense, mussarela, ovo, batata, tendo uma borda recheada com catupiri zero lactose.",
    price: 28.5,
  ...
  },
  {
    ...
    description:
      "Pizza recheada com frango, catupiri zero lactose, queijo zero lactose e batata doce.",
    price: 24,
  ...
  },
  {
    ...
    name: "Napolitana",
    description:
      "Pizza recheada com queijo zero lactose, mussarela, tomate, tendo uma borda recheada com catupiry zero lactose.",
    price: 30,
  ...
  },
  {
    ...
    description:
      "Sorvete de chocolate zero lactose com granulados para você se deliciar.",
    price: 6,
  ...
  },
  {
    ...
    name: "Flocos",
    description:
      "O tradicional flocos vem com cobertura em chocolate tudo zero lactose.",
    price: 7,
